...
class EGBSubscriber_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$this->class_prefix = $instance['class_prefix'];
		...
		<form id="egbcm_form" action="#">
			...
			<div class="form-group">
				...
				<input type="text" class="'.$this->class_prefix.'-form-control '.$this->class_prefix.'-text" id="egbcm_first_name" placeholder="'.$instance['first_name_field_text'].'" required>
			</div>
			<div class="form-group">
				'.($label ? '<label for="egbcm_last_name">'.$instance['last_name_field_text'].'</label>' : null).'
				<input type="text" class="'.$this->class_prefix.'-form-control '.$this->class_prefix.'-text" id="egbcm_last_name" placeholder="'.$instance['last_name_field_text'].'" required>
			</div>
			<div class="form-group">
				'.($label ? '<label for="egbcm_company">'.$instance['company_field_text'].'</label>' : null).'
				<input type="text" class="'.$this->class_prefix.'-form-control '.$this->class_prefix.'-text" id="egbcm_company" placeholder="'.$instance['company_field_text'].'">
			</div>
			<div class="form-group">
				'.($label ? '<label for="egbcm_email">'.$instance['email_field_text'].'</label>' : null).'
				<input type="email" class="'.$this->class_prefix.'-form-control '.$this->class_prefix.'-text" id="egbcm_email" placeholder="'.$instance['email_field_text'].'" required>
			</div>
	...
	public function form( $instance ) {
		...
		<p>
		    <label for="'.esc_attr( $this->get_field_id( 'class_prefix' ) ).'">'.esc_attr( 'Class Prefix:', 'egbmc_domain' ).'</label> 
			<input 
				class="widefat" 
				id="'.esc_attr( $this->get_field_id( 'class_prefix' ) ).'" 
